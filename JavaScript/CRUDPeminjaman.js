...
const url = 'https://us-east-1.aws.data.mongodb-api.com/app/serviceveedbook-ltudl/endpoint/GetBukuKeluarAPI'
const url2 = 'https://us-east-1.aws.data.mongodb-api.com/app/serviceveedbook-ltudl/endpoint/PostBukuKeluarAPI'
const url3 = 'https://us-east-1.aws.data.mongodb-api.com/app/serviceveedbook-ltudl/endpoint/DeleteBukuKeluarAPI'
...
$(document).ready(function(){
  ...
  const url5 = 'https://us-east-1.aws.data.mongodb-api.com/app/serviceveedbook-ltudl/endpoint/GetBukuKeluarAPI';
  ...
  fetch(url5)
    ...
    .then(data => {
      ...
      const notificationsHTML = data.map(item => 
        `<li><a href="#">Buku <b>${item.Judul}</b> Dipinjam oleh <b>${item.Peminjam}</b></a></li>`).join('');
